...
#Region "Long SqlProcess"
    ''' <summary>
    ''' Performs a long time data retrieval from the server
    ''' </summary>
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ProcessDataset(ByVal ConnectionString As String, _
                                        ByVal params() As SqlParameter, _
                                        ByVal CommandText As String) As DataSet
        Dim ds As New DataSet
        Dim da As New SqlDataAdapter
        Dim CmdStr As String = CommandText
        Dim Conn As String = ConnectionString : Dim Connection As New SqlConnection(Conn)
        Try
            Dim Command As New SqlCommand(CmdStr, Connection) : Command.CommandType = CommandType.Text
    ...
    ''' <summary>
    ''' Performs a long time data processing from the server
    ''' </summary>
    ''' <param name="ConnectionString"></param>
    ''' <param name="CommandText"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ProcessQuery(ByVal ConnectionString As String, _
                                        ByVal CommandText As String) As Integer
        Dim CmdStr As String = CommandText
        Dim Conn As String = ConnectionString : Dim Connection As New SqlConnection(Conn)
        Try
    ...
    ''' <summary>
    ''' Performs a long time data processing from the server with parameters
    ''' </summary>
    ''' <param name="ConnectionString"></param>
    ''' <param name="params"></param>
    ''' <param name="CommandText"></param>
